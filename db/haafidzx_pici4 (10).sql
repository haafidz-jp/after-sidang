...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2021 at 08:26 PM
...
ALTER TABLE `produk`
  ...
  ADD CONSTRAINT `produk_ibfk_4` FOREIGN KEY (`user_created`) REFERENCES `auth_groups` (`id`);
...
--
ALTER TABLE `supplier`
  ADD CONSTRAINT `supplier_ibfk_1` FOREIGN KEY (`user_created`) REFERENCES `auth_groups` (`id`);
COMMIT;
